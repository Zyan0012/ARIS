...
allowed-tools: Bash(*), Read, Write, Edit, Grep, Glob, WebSearch, WebFetch, Agent, mcp__codex-review__review, mcp__codex-review__review_reply, mcp__codex-review__review_start, mcp__codex-review__review_reply_start, mcp__codex-review__review_status
---
...
- **REVIEWER_MODEL = `gpt-5.4`** — Reviewer model used via `codex-review` MCP.
...
- **Save `threadId` from Phase 2** and use `mcp__codex-review__review_reply_start` for later rounds.
