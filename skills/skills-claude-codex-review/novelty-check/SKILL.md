...
allowed-tools: WebSearch, WebFetch, Grep, Read, Glob, mcp__codex-review__review, mcp__codex-review__review_reply, mcp__codex-review__review_start, mcp__codex-review__review_reply_start, mcp__codex-review__review_status
---
...
Call REVIEWER_MODEL via `codex-review` MCP (`mcp__codex-review__review_start`) with xhigh reasoning:
```
