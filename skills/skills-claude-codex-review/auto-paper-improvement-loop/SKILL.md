...
allowed-tools: Bash(*), Read, Write, Edit, Grep, Glob, Agent, mcp__codex-review__review, mcp__codex-review__review_reply, mcp__codex-review__review_start, mcp__codex-review__review_reply_start, mcp__codex-review__review_status
---
...
- **REVIEWER_MODEL = `gpt-5.4`** — Model used via `codex-review` MCP for paper review.
...
Use `mcp__codex-review__review_reply_start` with the saved threadId:
...
- **Use `mcp__codex-review__review_reply_start`** for Round 2 to maintain conversation context
